...
v2 changes:
* `mangling` has moved to `go-openapi/codegen/mangling`
* `jsonname` has moved next to its sole consumer: `go-openapi/jsonpointer/v2/jsonname`
* `cmdutils` has been removed
* `netutils` has been removed
* `fileutils` has been moved to `go-openapi/runtime/v2`
